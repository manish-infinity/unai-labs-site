...
- **Course 3 "Brain Health 101" (homepage COMING SOON card):** its course outline (courses/course-03-brain-health.md) and Module 1-3 lesson content (content/course-03-module-1-lessons.md, -module-2-lessons.md, -module-3-lessons.md) are DRAFTED in GitHub as of Sprint 26 but NOT in WordPress — a future authenticated sprint creates the Tutor course + Modules 1-3 lessons, writes Module 4, sets price, mirrors product 120 with a WooCommerce product, and replaces the homepage COMING SOON card with a real course card.
